...
%>
		...
		<!-- PHOTOSWIPE -->
		<script src="library/jquery/photoswipe/lib/klass.min.js"></script>
		<script src="library/jquery/photoswipe/code.photoswipe.jquery-3.0.5.min.js"></script>
		<link rel="stylesheet" href="library/jquery/photoswipe/photoswipe.css" type="text/css">
			
<% if (debugOn) { %>
		<script type="text/javascript" src="library/OpenLayers-2.13.1/lib/OpenLayers.js"></script>
...
<% if (conf.cssMov != null && conf.cssMov.length() > 0) { %>
		<% if (debugOn) { %>
		<link rel="stylesheet" href="css/<%= conf.cssMov %>/<%= conf.cssMov %>.css" />
		<% } else { %>
		<link rel="stylesheet" href="mobile/css/<%= conf.cssMov %>/<%= conf.cssMov %>.min.css" />
		<% } %>
		<link rel="stylesheet" href="mobile/css/jquery.mobile.structure-1.3.2.min.css" />
		<link rel="stylesheet" href="mobile/css/<%= conf.cssMov %>/style.css">
<% } %>
		<!-- Librerias Sitmun -->
