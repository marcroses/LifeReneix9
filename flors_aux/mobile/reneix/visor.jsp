...
<html lang="ca">
	<head>
		...
		<%@ include file="../visor-mob.jsp" %>
		
		<script src="/sitmun/mobile/reneix/js/reneix.js" type="text/javascript"></script>
						...
						<li>
							...
							<center>
								<table width="75%;" border=0>
									<tbody>
										<tr>
											<td width="32"><img src="/sitmun/mobile/reneix/img/distancia.png" style="max-width:25px;" title=<%= nls.getProperty("MA_FITXA_DISTANCIA") %>></td>
											...
											<td width="32"><img src="/sitmun/mobile/reneix/img/dificultat.png" style="max-width:25px;" title=<%= nls.getProperty("MA_FITXA_DIFICULTAT") %>></td>
											...
											<td width="32"><img src="/sitmun/mobile/reneix/img/temps.png" style="max-width:25px;" title=<%= nls.getProperty("MA_FITXA_TEMPS") %>></td>
											<td width="*/2"><div title="Temps" id="infoFitxaRUTATiempo" style="font-family: sans-serif; font-size: 12px;text-align:left;"></div></td>
											
											<td width="32"><img src="/sitmun/mobile/reneix/img/desAcuMax.png" style="max-width:25px;" title=<%= nls.getProperty("MA_FITXA_DESNIVELL") %>></td>
            ...
            <div data-role="content" >
                    	...
                    	<div data-role="controlgroup" style="padding:5px;">
                            <ul id="llistaIdioma" data-role="listview" data-theme="c">
                                <li key="cat" ><a href="/sitmun/mobile/reneix/visor.jsp?app=13&ter=1&lang=ca"><img src='/sitmun/mobile/reneix/img/lang_cat.png' style="height:35px;top:22px;left:15px;"/><div style="position:absolute;top:30px;">Catal&agrave;</div></a></li>
                                <li key="cas" ><a href="/sitmun/mobile/reneix/visor.jsp?app=13&ter=1&lang=es"><img src='/sitmun/mobile/reneix/img/lang_esp.png' style="height:35px;top:22px;left:15px;"/><div style="position:absolute;top:30px;">Castellano</div></a></li>
                            </ul>
                    	</div>    
